...
#   Update the UserPrincipalName for 'u1' to include an extra '@' character
#   Update the emailAddress for 'u2' to 'u2@pomonasyrup.com'
#   Update the emailAddress for 'u3' to 'u3@pomonasyrup.com'
#   Update the emailAddress for 'u4' to “u4 @pomonasyrup.com”
#   Update the emailAddress for 'u5' to “ “

# Update UPN for 'u1'
$upn = Get-ADUser u1 | Select UserPrincipalName
If ($upn.UserPrincipalName -notlike "*@@*"){
	$arrupn = $upn.UserPrincipalName -split '@'
	$newUPN = $arrUPN[0] + "@@" + $arrUPN[1]
	Set-ADUser u1 -UserPrincipalName $newUPN
	Write-Host "u1 was updated successfully"
} Else {
	Write-Host "u1 was ALREADY updated"
}

# Update emailAddress for 'u2'
$emailu2 = Get-ADUser u2 -Properties emailAddress | Select emailAddress
If ($emailu2.emailAddress -notlike "u2@pomonasyrup.com"){
	Set-ADUser u2 -emailAddress u2@pomonasyrup.com
	Write-Host "u2 was updated successfully"
} Else {
	Write-Host "u2 was ALREADY updated"
}

# Update emailAddress for 'u3'
$emailu3 = Get-ADUser u3 -Properties emailAddress | Select emailAddress
If ($emailu3.emailAddress -notlike "u2@pomonasyrup.com"){
	Set-ADUser u3 -emailAddress u2@pomonasyrup.com
	Write-Host "u3 was updated successfully"
} Else {
	Write-Host "u3 was ALREADY updated"
}

# Update emailAddress for 'u4'
$emailu4 = Get-ADUser u4 -Properties emailAddress | Select emailAddress
If ($emailu4.emailAddress -notlike "u4 @pomonasyrup.com"){
	Set-ADUser u4 -emailAddress "u4 @pomonasyrup.com"
	Write-Host "u4 was updated successfully"
} Else {
	Write-Host "u4 was ALREADY updated"
}

# Update emailAddress for 'u5'
$emailu5 = Get-ADUser u5 -Properties emailAddress | Select emailAddress
If ($emailu5.emailAddress -notlike " "){
	Set-ADUser u5 -emailAddress " "
	Write-Host "u5 was updated successfully"
} Else {
	Write-Host "u5 was already updated"
}
# SIG # Begin signature block
# MIIdpQYJKoZIhvcNAQcCoIIdljCCHZICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPPkTYcQErRoxwPmY6a/w4C/X
# e4SgghhlMIIEwzCCA6ugAwIBAgITMwAAAMzLuBPrXXItRQAAAAAAzDANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFFM/8abCvMQkPq731+oYBCMJIfO8MF4GCisG
...
# SIb3DQEBAQUABIIBADW1K46bP7hfJA9IorJjBASXhDSm6f8ud3mnfMWJ4J/8AUSC
# nKRSzLjR4dO+lbruvOweIhQn2nCyXxemsapx8L3mOWkw50cEvlPJy85uzU6PV4Jl
# Vo5tqh7chZB1EMGCohf04HZJS1UBq642+fJ0BqkQVerEshSxgz2tEQXUI/DcU1OR
# Zz7rlRitSJJaSLoM5giH5tC1KiWFSWn0ROKjZUplfPoQu2CUekaYIVEIGtfvn1T+
# Wu8JoL12+6CUamfxzaqNmN4etbVJfAESdSIG6Ct1JUK6D4i5dnmhUstWfOXJLAuZ
# Ug1JTmc29HtGKxskxC2RumlamHm/VwliMU9T9quhggIoMIICJAYJKoZIhvcNAQkG
# MYICFTCCAhECAQEwgY4wdzELMAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0
# b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3Jh
# dGlvbjEhMB8GA1UEAxMYTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENBAhMzAAAAzMu4
# E+tdci1FAAAAAADMMAkGBSsOAwIaBQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcN
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xNzAyMjExOTEzNTVaMCMGCSqGSIb3DQEJBDEW
# BBTYnKZA8MsXOa1xq4O3Bd1ajO04yzANBgkqhkiG9w0BAQUFAASCAQAxUDhqOP3U
# pYKwB5RGVpvh6L9bZ35WySlei+36Mh3AlWMgzBh2TTPfsmmc1IL6EwH+jH6BSJun
# Er6W6cxgkLqLkGuVJoT9hNx0SE7aciaYTgA/AUi0bUKYq7UQ5H92YXocMBadP087
# X3FDsl0qurrzTOi8l15dGqBo3XVg8ZZVqvP3rhe7inwxwZzrF02CEcOgDbjC4Km1
# /QpVZ3hKzmon9A9SUBPe2FmKlOCgXdPrz0IaL9taQU9MtIEY+hGEnTzYeb7Lrz02
# UUKDZBXY2dBVRoRWTUrsQxmQ0BEN+kzqjgXLWE/DpVfmzYf5nYjBt8ufVo6NoNct
# a86IwVQLoYl8
